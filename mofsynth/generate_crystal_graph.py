...
def preprocess(inputs):
    ...
    try:
        ...
        # Skip files with unknown elements
        print(f"Skipping {cif_id}: contains unknown element")
        return
...
if __name__ == '__main__':
    ...
    parser.add_argument('--idprop', type=str, default='./data/id_prop.csv', help='id-prop.csv file')
